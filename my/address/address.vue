<template>
	...
	<view class="container" style="position: relative;">
		<view v-if="flag">
			...
			<uni-nav-bar left-icon="back" right-text="添加" @click-left='back' @click-right='add' title="提币地址" background-color="#121212"
			 color='#fff' border='false' shadow='false'></uni-nav-bar>
		...
		<view v-else>
			<view class="height"></view>
			<uni-nav-bar left-icon="back" title="提币地址" @click-left='back' background-color="#121212" color='#fff' border='false'
	...
	export default {
		...
		methods: {
			...
			edit: function(item) {
				...
				uni.navigateTo({
					url: '../edit-address/edit-address?id=' + that.id + '&wallet_key=' + that.wallet_key + '&wallet_value=' + that.wallet_value +
