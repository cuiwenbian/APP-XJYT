<template>
	<view>
		...
		<view class="form-list-wrap all03s" :class="{ active: numFocusStatus }" :style="{'paddingTop':isFocus?'10rpx':'60rpx'}">
			...
			<view class="write-wrap"><input type="number" value="" class="write-input" @focus="formItemFocus('num')" @blur="formItemBlur('num')" v-model="numVal" maxlength="20" /></view>
			<view class="other-info am-flex-rc-between">
				<text class="cur-text">
					当前可用
					<text class="tr-num">{{number}}T</text>
				</text>
