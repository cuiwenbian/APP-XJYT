...
var xME=_mz(z,'view',['bindtap',6,'class',1,'data-event-opts',2,'id',3],[],eJE,tIE,gg)
var oNE=_n('view')
_rz(z,oNE,'class',10,eJE,tIE,gg)
var fOE=_n('view')
var cPE=_v()
_(fOE,cPE)
if(_oz(z,11,eJE,tIE,gg)){cPE.wxVkey=1
}
else{cPE.wxVkey=2
var cSE=_v()
_(cPE,cSE)
if(_oz(z,12,eJE,tIE,gg)){cSE.wxVkey=1
}
cSE.wxXCkey=1
}
var hQE=_v()
_(fOE,hQE)
if(_oz(z,13,eJE,tIE,gg)){hQE.wxVkey=1
}
var oRE=_v()
_(fOE,oRE)
if(_oz(z,14,eJE,tIE,gg)){oRE.wxVkey=1
}
cPE.wxXCkey=1
hQE.wxXCkey=1
oRE.wxXCkey=1
...
var lUE=_v()
_(oTE,lUE)
if(_oz(z,15,eJE,tIE,gg)){lUE.wxVkey=1
}
var aVE=_v()
_(oTE,aVE)
if(_oz(z,16,eJE,tIE,gg)){aVE.wxVkey=1
}
var tWE=_v()
_(oTE,tWE)
if(_oz(z,17,eJE,tIE,gg)){tWE.wxVkey=1
}
var eXE=_v()
_(oTE,eXE)
if(_oz(z,18,eJE,tIE,gg)){eXE.wxVkey=1
}
var bYE=_v()
_(oTE,bYE)
if(_oz(z,19,eJE,tIE,gg)){bYE.wxVkey=1
}
var oZE=_v()
_(oTE,oZE)
if(_oz(z,20,eJE,tIE,gg)){oZE.wxVkey=1
}
lUE.wxXCkey=1
aVE.wxXCkey=1
tWE.wxXCkey=1
...
lGE.wxXCkey=2
_2z(z,4,aHE,e,s,gg,lGE,'item','index','index')
}
else{cEE.wxVkey=2
}
var oFE=_v()
...
var z=gz$gwx_38()
var o2E=_mz(z,'dy-date-picker',['bind:__l',0,'bind:getData',1,'data-event-opts',1,'placeholder',2,'timeType',3,'value',4,'vueId',5],[],e,s,gg)
_(r,o2E)
return r
}
...
var eBF=_mz(z,'password-input',['bind:__l',2,'bind:clo',1,'bind:tap',2,'class',3,'data-event-opts',4,'data-ref',5,'gutter',6,'length',7,'list',8,'vueId',9],[],e,s,gg)
_(tAF,eBF)
}
var bCF=_mz(z,'keyboard-package',['bind:__l',12,'bind:onChange',1,'bind:onConfirm',2,'bind:onDelete',3,'bind:onInput',4,'class',5,'data-event-opts',6,'data-ref',7,'disableDot',8,'vueId',9],[],e,s,gg)
_(a0E,bCF)
tAF.wxXCkey=1
tAF.wxXCkey=3
_(r,a0E)
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/register/register"],{"15c4":function(t,e,n){},"8c41":function(t,e,n){"use strict";n.r(e);var o=n("f26d"),i=n.n(o);for(var s in o)"default"!==s&&function(t){n.d(e,t,function(){return o[t]})}(s);e["default"]=i.a},a620:function(t,e,n){"use strict";var o=function(){var t=this,e=t.$createElement;t._self._c},i=[];n.d(e,"a",function(){return o}),n.d(e,"b",function(){return i})},c779:function(t,e,n){"use strict";(function(t){n("9c0b"),n("921b");o(n("66fd"));var e=o(n("e8d8"));function o(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,n("6e42")["createPage"])},e8d8:function(t,e,n){"use strict";n.r(e);var o=n("a620"),i=n("8c41");for(var s in i)"default"!==s&&function(t){n.d(e,t,function(){return i[t]})}(s);n("f869");var a=n("2877"),u=Object(a["a"])(i["default"],o["a"],o["b"],!1,null,null,null);e["default"]=u.exports},f26d:function(t,e,n){"use strict";(function(t,n){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var o={data:function(){return{show:!1,shade:!1,phone:"",pwd:"",pwd1:"",code:"",iscode:"",codename:" 获取验证码 ",disabled:!1,flag:!0}},methods:{getPhoneValue:function(t){this.phone=t.detail.value},getPwdValue:function(t){this.pwd=t.detail.value},getPwdValue1:function(t){this.pwd1=t.detail.value},getCodeValue:function(t){this.code=t.detail.value},getCode:function(){var e=this,o=/^(16[0-9]|14[0-9]|13[0-9]|15[0-9]|17[0-9]|18[0-9]|19[0-9])\d{8}$$/;return""==this.phone?(t.showToast({title:"手机号不能为空",icon:"none",duration:1e3}),!1):o.test(this.phone)?void t.request({url:e.url+"users/regist/sms/",method:"POST",data:{mobile:this.phone},header:{"Content-Type":"application/x-www-form-urlencoded"},success:function(o){console.log(n(o," at pages\\register\\register.vue:98"));var i=o.statusCode;if(200==i){e.iscode=o.data.data;var s=61,a=setInterval(function(){s--,s<=0?(clearInterval(a),e.codename="重新发送",e.disabled=!1):(e.flag=!1,e.codename=s+"s",e.disabled=!0)},1e3)}else{if(411==i)return t.showToast({title:"操作太频繁，请稍候重试",icon:"none",duration:2e3}),!1;if(400==i)return t.showToast({title:"手机号已注册",icon:"none",duration:2e3}),!1}}}):(t.showToast({title:"请输入正确的手机号",icon:"none",duration:1e3}),!1)},getCodeBtn:function(t){this.getCode()},register:function(){var e=this,n=this;if(""==this.phone)return t.showToast({title:"请输入手机号",icon:"none",duration:2e3}),!1;var o=/^(16[0-9]|14[0-9]|13[0-9]|15[0-9]|17[0-9]|18[0-9]|19[0-9])\d{8}$$/;if(!o.test(this.phone))return t.showToast({title:"请输入正确的手机号",icon:"none",duration:2e3}),!1;if(""==this.pwd)return t.showToast({title:"请输入登录密码",icon:"none",duration:2e3}),!1;var i=/^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,16}$/;return i.test(this.pwd)?""==this.pwd1?(t.showToast({title:"请确认登录密码",icon:"none",duration:2e3}),!1):this.pwd1!==this.pwd?(t.showToast({title:"两次密码不一致",icon:"none",duration:2e3}),!1):""==this.code?(t.showToast({title:"验证码不能为空",icon:"none",duration:2e3}),!1):this.code!=this.iscode?(t.showToast({title:"验证码错误",icon:"none",duration:2e3}),!1):void t.request({url:this.url+"users/regist/",method:"POST",data:{mobile:this.phone,password:this.pwd,sec_password:this.pwd1,code:this.code},headers:{"Content-Type":"application/json"},success:function(o){n.global_.phone=e.phone,n.global_.token=o.data.token,400==o.statusCode&&t.showToast({title:"验证码已过期",icon:"none"}),201==o.statusCode&&(e.shade=!0)},fail:function(){},complete:function(){}}):(t.showToast({title:"密码格式不正确",icon:"none",duration:2e3}),!1)},sure:function(){t.navigateTo({url:"../login/login"})}}};e.default=o}).call(this,n("6e42")["default"],n("0de9")["default"])},f869:function(t,e,n){"use strict";var o=n("15c4"),i=n.n(o);i.a}},[["c779","common/runtime","common/vendor"]]]);
});
require('pages/register/register.js');
__wxRoute = 'pages/index/index';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/index/index.js';

define('pages/index/index.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/index"],{"0958":function(e,t,a){"use strict";var n=a("d64e"),i=a.n(n);i.a},"0a6f":function(e,t,a){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,i=r(a("45f4"));function r(e){return e&&e.__esModule?e:{default:e}}function o(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}var u=null,s={data:function(){return{Todayprice:"",yesterdayprice:"",yesterday:"",seven_profit:"",total_profit:"",cWidth:"",cHeight:"",pixelRatio:1,notice:"",csgo:"",time:[],price:[],hure:[],feck:[],usd:"",hige:"",minn:""}},onLoad:function(){n=this;var t=this;this.cWidth=e.upx2px(750),this.cHeight=e.upx2px(550),n.getServerData(),e.request({url:this.url+"home/",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(e){var a=e.data;t.csgo=a}})},methods:{web1:function(){e.navigateTo({url:"../web1/web1"})},web2:function(){e.navigateTo({url:"../web2/web2"})},getServerData:function(){var t=this,a=Date.parse(new Date)/1e3,i=(new Date,518400),r=a-i;e.request({url:"https://gateio.org/json_svr/query/?u=10&c=9137018&type=tvkline&symbol=fil_usdt&from=".concat(r,"&to=").concat(a,"&interval=28800"),method:"POST",success:function(e){function a(e){var t=new Date(e),a=(t.getFullYear(),t.getMonth()+1);a=a<10?"0"+a:a;var n=t.getDate();n=n<10?"0"+n:n;var i=t.getHours();i=i<10?"0"+i:i;var r=t.getMinutes();return r=r<10?"0"+r:r,a+"-"+n}var i=e.data.split("\n");t.usd=i;for(var r=[],o=[],u=[],s=1;s<t.usd.length-1;s++){var l=i[s].split(",")[0],c=a(parseInt(l));r.push(c),t.time=r;var d=new Date;d.setTime(d.getTime()-864e5);d.getFullYear(),d.getMonth(),d.getDate()}for(var f=1;f<t.usd.length-1;f++){var h=i[f].split(",")[2],p=parseFloat(h);o.push(p),t.price=o}for(var g=1;g<t.usd.length-1;g++){var v=i[g].split(",")[1],m=parseFloat(v);u.push(m),t.feck=u}for(var b=1;b<t.usd.length-1;b++)var y=i[b].split(",")[3];var w=parseFloat(i[i.length-2].split(",")[4]),x=parseFloat(i[i.length-6].split(",")[4]),T=w-x,_=T.toFixed(2),F=100*(w/v-1);c=F.toFixed(2)+"%";n.hige=parseFloat(h)+1,n.minn=parseFloat(y)-1,t.Todayprice=w,t.yesterday=c,t.yesterdayprice=_,(_>0||c>0)&&(t.yest="+"+t.yest);var C={list:[]};C.list=t.usd,n.showArea("canvasArea",t.usd)}})},showArea:function(e,t){var a;u=new i.default((a={$this:n,canvasId:e,type:"area",fontSize:11,legend:!0,dataLabel:!1},o(a,"legend",{show:!1}),o(a,"dataPointShape",!1),o(a,"legend",{show:!1}),o(a,"pixelRatio",n.pixelRatio),o(a,"categories",n.time),o(a,"series",[{name:"FIL价格",data:n.price,color:"#58f4e3"}]),o(a,"animation",!0),o(a,"xAxis",{type:"grid",gridColor:"#333535",disableGrid:!0,gridType:"solid",dashLength:8,axisLineColor:"#333535",itemCount:20,labelCount:8}),o(a,"yAxis",{type:"grid",gridType:"solid",gridColor:"#333535",dashLength:8,splitNumber:4,min:n.minn,max:n.hige,axisLineColor:"#333",format:function(e){return e.toFixed(1)}}),o(a,"width",n.cWidth*n.pixelRatio),o(a,"height",n.cHeight*n.pixelRatio),o(a,"extra",{area:{type:"straight",opacity:.2,addLine:!0,width:1,gradient:!0}}),a))},touchCandle:function(e){u.scrollStart(e)},moveCandle:function(e){u.scroll(e)},touchEndCandle:function(e){u.scrollEnd(e),u.showToolTip(e,{format:function(e,t){return t+" "+e.name+":"+e.data}})},touchArea:function(e){u.showToolTip(e,{format:function(e,t){return t+" "+e.name+":"+e.data}})}}};t.default=s}).call(this,a("6e42")["default"])},"1dc5":function(e,t,a){"use strict";a.r(t);var n=a("0a6f"),i=a.n(n);for(var r in n)"default"!==r&&function(e){a.d(t,e,function(){return n[e]})}(r);t["default"]=i.a},"5b5e":function(e,t,a){"use strict";var n=function(){var e=this,t=e.$createElement;e._self._c},i=[];a.d(t,"a",function(){return n}),a.d(t,"b",function(){return i})},"6f64":function(e,t,a){"use strict";a.r(t);var n=a("5b5e"),i=a("1dc5");for(var r in i)"default"!==r&&function(e){a.d(t,e,function(){return i[e]})}(r);a("0958");var o=a("2877"),u=Object(o["a"])(i["default"],n["a"],n["b"],!1,null,null,null);t["default"]=u.exports},a5ed:function(e,t,a){"use strict";(function(e){a("9c0b"),a("921b");n(a("66fd"));var t=n(a("6f64"));function n(e){return e&&e.__esModule?e:{default:e}}e(t.default)}).call(this,a("6e42")["createPage"])},d64e:function(e,t,a){}},[["a5ed","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/agreement/agreement"],{"0b18":function(e,t,a){},"10fd":function(e,t,a){"use strict";(function(e){a("9c0b"),a("921b");n(a("66fd"));var t=n(a("a665"));function n(e){return e&&e.__esModule?e:{default:e}}e(t.default)}).call(this,a("6e42")["createPage"])},2304:function(e,t,a){"use strict";var n=function(){var e=this,t=e.$createElement;e._self._c},o=[];a.d(t,"a",function(){return n}),a.d(t,"b",function(){return o})},"5db6":function(e,t,a){"use strict";var n=a("0b18"),o=a.n(n);o.a},a0e9:function(e,t,a){"use strict";(function(e,a){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n={data:function(){return{agreement:"",chnerot:"",flag:!1,fllaag:!1}},onShow:function(){var t=this;e.request({url:this.url+"usermachine/agreement/",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(e){console.log(a(e," at pages\\agreement\\agreement.vue:35")),t.chnerot=e.data.data.user_agreement,t.agreement=e.data.data.agreement,console.log(a(t.agreement," at pages\\agreement\\agreement.vue:38")),0==t.chnerot&&(t.flag=!0)}})},methods:{sss:function(){var t=this;e.request({url:this.url+"usermachine/agreement/",method:"POST",header:{Authorization:"JWT "+this.global_.token},success:function(n){console.log(a(n," at pages\\agreement\\agreement.vue:56")),200==n.statusCode&&(t.fllaag=!0,t.flag=!1,e.showToast({title:"已阅读并同意协议"}))}})},aaa:function(){var t=e.downloadFile({url:this.url+"media/用户服务协议.pdf",success:function(t){console.log(a(t," at pages\\agreement\\agreement.vue:72")),200===t.statusCode&&(console.log(a("下载成功"," at pages\\agreement\\agreement.vue:74")),e.showToast({title:"下载成功",duration:3e3}))}});t.onProgressUpdate(function(e){console.log(a("下载进度"+e.progress," at pages\\agreement\\agreement.vue:83")),console.log(a("已经下载的数据长度"+e.totalBytesWritten," at pages\\agreement\\agreement.vue:84")),console.log(a("预期需要下载的数据总长度"+e.totalBytesExpectedToWrite," at pages\\agreement\\agreement.vue:85"))})}}};t.default=n}).call(this,a("6e42")["default"],a("0de9")["default"])},a665:function(e,t,a){"use strict";a.r(t);var n=a("2304"),o=a("e3de");for(var r in o)"default"!==r&&function(e){a.d(t,e,function(){return o[e]})}(r);a("5db6");var u=a("2877"),s=Object(u["a"])(o["default"],n["a"],n["b"],!1,null,null,null);t["default"]=s.exports},e3de:function(e,t,a){"use strict";a.r(t);var n=a("a0e9"),o=a.n(n);for(var r in n)"default"!==r&&function(e){a.d(t,e,function(){return n[e]})}(r);t["default"]=o.a}},[["10fd","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/banner/banner"],{"0103":function(n,t,e){},"088f":function(n,t,e){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var u={data:function(){return{tet:"",fz:"",mlet:""}}};t.default=u},"1e1e":function(n,t,e){"use strict";var u=function(){var n=this,t=n.$createElement;n._self._c},r=[];e.d(t,"a",function(){return u}),e.d(t,"b",function(){return r})},"29dd":function(n,t,e){"use strict";e.r(t);var u=e("1e1e"),r=e("e8d4");for(var a in r)"default"!==a&&function(n){e.d(t,n,function(){return r[n]})}(a);e("36d7");var c=e("2877"),f=Object(c["a"])(r["default"],u["a"],u["b"],!1,null,null,null);t["default"]=f.exports},"36d7":function(n,t,e){"use strict";var u=e("0103"),r=e.n(u);r.a},8253:function(n,t,e){"use strict";(function(n){e("9c0b"),e("921b");u(e("66fd"));var t=u(e("29dd"));function u(n){return n&&n.__esModule?n:{default:n}}n(t.default)}).call(this,e("6e42")["createPage"])},e8d4:function(n,t,e){"use strict";e.r(t);var u=e("088f"),r=e.n(u);for(var a in u)"default"!==a&&function(n){e.d(t,n,function(){return u[n]})}(a);t["default"]=r.a}},[["8253","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["mill/mill/mill"],{"09b1":function(t,e,n){"use strict";(function(t){n("9c0b"),n("921b");a(n("66fd"));var e=a(n("a7e0"));function a(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,n("6e42")["createPage"])},2464:function(t,e,n){"use strict";(function(t,n){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a={data:function(){return{many:"0",user_id:[],flag:!1,selectilall:!1,machine_id:"",lo:!1,arr:[],isSelected:!1,checkbox:[{value:"A",checked:!1}]}},onLoad:function(e){setTimeout(function(){console.log(t("start pulldown"," at mill\\mill\\mill.vue:73"))},100),n.startPullDownRefresh()},onPullDownRefresh:function(){setTimeout(function(){n.stopPullDownRefresh()},100)},onShow:function(t){var e=this;n.request({url:this.url+"mainmachine/",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(t){200==t.statusCode&&(e.user_id=t.data.data,e.many=t.data.data.length,e.machine_id=t.data.data[length].machine_id),205==t.statusCode&&(e.flag=!0)}})},methods:{pay:function(){n.navigateTo({url:"../pay/pay"})},sale:function(){n.navigateTo({url:"../sale/sale"})},CheckboxChange:function(t){var e=this;e.arr=[];for(var n=0;n<e.user_id.length;n++)e.user_id.checked=!1;for(var a=e.user_id,l=t.detail.value,o=0,i=a.length;o<i;++o){a.checked=!0;for(var u=0,c=l.length;u<c;++u)if(a[o].number==l[u]){a.checked=!0,e.arr.push(a[o].machine_id);break}}},btn2:function(){var e=this,a=e.arr.join(",");console.log(t(a," at mill\\mill\\mill.vue:135")),n.request({url:"http://192.168.1.208:8000/api/v1.1.0/buildorders/",method:"GET",header:{Authorization:"JWT "+this.global_.token},data:{machine_id_list:a},success:function(a){console.log(t(a," at mill\\mill\\mill.vue:146"));var l=JSON.stringify(a.data.data);401==a.statusCode?n.showModal({content:"未进行实名认证",confirmText:"去验证",success:function(e){e.confirm?n.navigateTo({url:"../../my/identity/identity"}):e.cancel&&console.log(t("用户点击取消"," at mill\\mill\\mill.vue:158"))}}):302==a.statusCode?n.showToast({title:"实名认证审核中"}):400==a.statusCode?n.showModal({content:"未设置交易密码",confirmText:"去设置",success:function(e){e.confirm?n.switchTab({url:"../../my/my/my"}):e.cancel&&console.log(t("用户点击取消"," at mill\\mill\\mill.vue:178"))}}):0==e.arr.length?n.showToast({title:"请选择矿机",icon:"none"}):200==a.statusCode&&n.navigateTo({url:"../sell/sell?tar="+l})}})}}};e.default=a}).call(this,n("0de9")["default"],n("6e42")["default"])},"6c9f":function(t,e,n){},a3c0:function(t,e,n){"use strict";var a=n("6c9f"),l=n.n(a);l.a},a7e0:function(t,e,n){"use strict";n.r(e);var a=n("f4d8"),l=n("fb6d");for(var o in l)"default"!==o&&function(t){n.d(e,t,function(){return l[t]})}(o);n("a3c0");var i=n("2877"),u=Object(i["a"])(l["default"],a["a"],a["b"],!1,null,null,null);e["default"]=u.exports},f4d8:function(t,e,n){"use strict";var a=function(){var t=this,e=t.$createElement;t._self._c},l=[];n.d(e,"a",function(){return a}),n.d(e,"b",function(){return l})},fb6d:function(t,e,n){"use strict";n.r(e);var a=n("2464"),l=n.n(a);for(var o in a)"default"!==o&&function(t){n.d(e,t,function(){return a[t]})}(o);e["default"]=l.a}},[["09b1","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["mill/pay/pay"],{"32da":function(t,a,e){"use strict";e.r(a);var n=e("9435"),r=e.n(n);for(var o in n)"default"!==o&&function(t){e.d(a,t,function(){return n[t]})}(o);a["default"]=r.a},"36f7":function(t,a,e){"use strict";(function(t){e("9c0b"),e("921b");n(e("66fd"));var a=n(e("53b8"));function n(t){return t&&t.__esModule?t:{default:t}}t(a.default)}).call(this,e("6e42")["createPage"])},"3a3a":function(t,a,e){"use strict";var n=function(){var t=this,a=t.$createElement;t._self._c},r=[];e.d(a,"a",function(){return n}),e.d(a,"b",function(){return r})},"483a":function(t,a,e){"use strict";var n=e("622b"),r=e.n(n);r.a},"53b8":function(t,a,e){"use strict";e.r(a);var n=e("3a3a"),r=e("32da");for(var o in r)"default"!==o&&function(t){e.d(a,t,function(){return r[t]})}(o);e("483a");var u=e("2877"),s=Object(u["a"])(r["default"],n["a"],n["b"],!1,null,null,null);a["default"]=s.exports},"622b":function(t,a,e){},9435:function(t,a,e){"use strict";(function(t,e){Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var n={data:function(){return{many:"0",tabCurrentIndex:0,contion:"",daker:"",lornd:"",kolo:"",flag:!1,navList:[{state:0,text:"待付款"},{state:1,text:"待确认"},{state:2,text:"待审核"},{state:3,text:"已完成"}]}},onLoad:function(a){var e=this;this.getData(),t.request({url:this.url+"ordernum/1",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(t){e.many=t.data.data}})},methods:{getData:function(){var a=this;t.request({url:this.url+"buyall/101",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(t){var e=t.data.data;a.contion=e.reverse()}})},tabClick:function(a){var e=this;if(this.tabCurrentIndex===a)return!1;e.tabCurrentIndex=a,1===this.tabCurrentIndex&&t.request({url:this.url+"buyall/102",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(t){var a=t.data.data;e.kolo=a.reverse()}}),2===this.tabCurrentIndex&&t.request({url:this.url+"buyall/103",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(t){var a=t.data.data;e.lornd=a.reverse()}}),3===this.tabCurrentIndex&&t.request({url:this.url+"buyall/104",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(t){var a=t.data.data;e.daker=a.reverse()}})},btn:function(a){t.request({url:this.url+"salemessage/",method:"GET",header:{Authorization:"JWT "+this.global_.token},data:{order_num:a.order_num},success:function(a){var e=JSON.stringify(a.data.data);t.navigateTo({url:"../staypay/staypay?mvvp="+e})}})},bt:function(a){var n=this;t.request({url:this.url+"ordercancel/",method:"POST",header:{Authorization:"JWT "+this.global_.token},data:{order_num:a.order_num},success:function(a){console.log(e(this.url," at mill\\pay\\pay.vue:300")),200==a.statusCode?t.showToast({title:"删除成功",icon:"none",duration:2e3}):400==a.statusCode&&t.showToast({title:"该订单不可删除",icon:"none",duration:2e3}),n.getData()}})},btn2:function(a){t.request({url:this.url+"salemessage/",method:"GET",header:{Authorization:"JWT "+this.global_.token},data:{order_num:a.order_num},success:function(a){var e=JSON.stringify(a.data.data);t.navigateTo({url:"../stayconfirm/stayconfirm?main="+e})}})},btn3:function(a){t.request({url:this.url+"salemessage/",method:"GET",header:{Authorization:"JWT "+this.global_.token},data:{order_num:a.order_num},success:function(a){var e=JSON.stringify(a.data.data);t.navigateTo({url:"../stayaudit/stayaudit?dospp="+e})}})},btn4:function(a){t.request({url:this.url+"salemessage/",method:"GET",header:{Authorization:"JWT "+this.global_.token},data:{order_num:a.order_num},success:function(a){var e=JSON.stringify(a.data.data);t.navigateTo({url:"../completed/completed?deattr="+e})}})}}};a.default=n}).call(this,e("6e42")["default"],e("0de9")["default"])}},[["36f7","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["mill/stayconfirm/stayconfirm"],{2886:function(t,e,n){},"4c17":function(t,e,n){"use strict";n.r(e);var a=n("f793"),r=n("e158");for(var c in r)"default"!==c&&function(t){n.d(e,t,function(){return r[t]})}(c);n("ff28");var i=n("2877"),u=Object(i["a"])(r["default"],a["a"],a["b"],!1,null,null,null);e["default"]=u.exports},"5b4c":function(t,e,n){"use strict";(function(t){n("9c0b"),n("921b");a(n("66fd"));var e=a(n("4c17"));function a(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,n("6e42")["createPage"])},"8b0e":function(t,e,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a=n("f7ed"),r={data:function(){return{type:"买入",state:"",mill:"",rmb:"",x:"",fanta:"",pay_time:"",set_time:"",name:"",contact:"",ig:"",frte:!0,checkall:"查看全部"}},onLoad:function(t){var e=this,n=JSON.parse(t.main);e.fanta=n;e.fanta[1];e.ig=e.fanta[1],e.state=n[0][0].order_status,102==e.state&&(e.state="待确认"),e.mill=n[0][0].sale_num,e.price=n[0][0].sale_money,e.x=n[0][0].order_num,e.name=n[0][0].name,e.contact=n[0][0].mobile,e.set_time=n[0][0].set_time,e.pay_time=n[0][0].pay_time,e.rmb=a.getrmb(e.price)},methods:{btn:function(){var t=this;t.frte=!t.frte,0==t.frte?t.checkall="收起":t.checkall="查看全部"}}};e.default=r},e158:function(t,e,n){"use strict";n.r(e);var a=n("8b0e"),r=n.n(a);for(var c in a)"default"!==c&&function(t){n.d(e,t,function(){return a[t]})}(c);e["default"]=r.a},f793:function(t,e,n){"use strict";var a=function(){var t=this,e=t.$createElement;t._self._c},r=[];n.d(e,"a",function(){return a}),n.d(e,"b",function(){return r})},ff28:function(t,e,n){"use strict";var a=n("2886"),r=n.n(a);r.a}},[["5b4c","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["mill/stayaudit/stayaudit"],{"33c0":function(e,t,n){"use strict";n.r(t);var a=n("47f0"),r=n("c397");for(var c in r)"default"!==c&&function(e){n.d(t,e,function(){return r[e]})}(c);n("37be");var i=n("2877"),u=Object(i["a"])(r["default"],a["a"],a["b"],!1,null,null,null);t["default"]=u.exports},"37be":function(e,t,n){"use strict";var a=n("e596"),r=n.n(a);r.a},3853:function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=n("f7ed"),r={data:function(){return{type:"买入",state:"",cander:"",mill:"",price:"",hberd:"",rmb:"",x:"",set_time:"",pay_time:"",confirm_time:"",name:"",contact:"",frte:!0,checkall:"查看全部"}},onLoad:function(e){var t=this,n=JSON.parse(e.dospp);t.cander=n;t.cander[1];t.hberd=t.cander[1],t.state=n[0][0].order_status,103==t.state&&(t.state="待审核"),t.mill=t.cander[0][0].sale_num,t.price=t.cander[0][0].sale_money,t.x=t.cander[0][0].order_num,t.name=t.cander[0][0].name,t.contact=t.cander[0][0].mobile,t.confirm_time=t.cander[0][0].confirm_time,t.set_time=t.cander[0][0].set_time,t.pay_time=t.cander[0][0].pay_time,t.rmb=a.getrmb(t.price)},methods:{btn:function(){var e=this;e.frte=!e.frte,0==e.frte?e.checkall="收起":e.checkall="查看全部"}}};t.default=r},"47f0":function(e,t,n){"use strict";var a=function(){var e=this,t=e.$createElement;e._self._c},r=[];n.d(t,"a",function(){return a}),n.d(t,"b",function(){return r})},"6d33":function(e,t,n){"use strict";(function(e){n("9c0b"),n("921b");a(n("66fd"));var t=a(n("33c0"));function a(e){return e&&e.__esModule?e:{default:e}}e(t.default)}).call(this,n("6e42")["createPage"])},c397:function(e,t,n){"use strict";n.r(t);var a=n("3853"),r=n.n(a);for(var c in a)"default"!==c&&function(e){n.d(t,e,function(){return a[e]})}(c);t["default"]=r.a},e596:function(e,t,n){}},[["6d33","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["mill/completed/completed"],{"2ab4":function(t,e,n){"use strict";(function(t){n("9c0b"),n("921b");a(n("66fd"));var e=a(n("ff9b"));function a(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,n("6e42")["createPage"])},"53c2":function(t,e,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a=n("f7ed"),i={data:function(){return{type:"买入",state:"",mill:"",price:"",rmb:"",bsow:"",geunt:"",finish_time:"",pay_time:"",set_time:"",x:"",time:"",name:"",contact:"",frte:!0,checkall:"查看全部"}},onLoad:function(t){var e=this,n=JSON.parse(t.deattr);e.bsow=n;e.bsow[1];e.geunt=e.bsow[1],e.state=n[0][0].order_status,104==e.state&&(e.state="已完成"),e.mill=n[0][0].sale_num,e.price=n[0][0].sale_money,e.x=n[0][0].order_num,e.name=n[0][0].name,e.contact=n[0][0].mobile,e.time=n[0][0].confirm_time,e.finish_time=n[0][0].finish_time,e.pay_time=n[0][0].pay_time,e.set_time=n[0][0].set_time,e.rmb=a.getrmb(e.price)},methods:{btn:function(){var t=this;t.frte=!t.frte,0==t.frte?t.checkall="收起":t.checkall="查看全部"}}};e.default=i},a891:function(t,e,n){"use strict";var a=n("f288"),i=n.n(a);i.a},af2c:function(t,e,n){"use strict";n.r(e);var a=n("53c2"),i=n.n(a);for(var r in a)"default"!==r&&function(t){n.d(e,t,function(){return a[t]})}(r);e["default"]=i.a},d76b:function(t,e,n){"use strict";var a=function(){var t=this,e=t.$createElement;t._self._c},i=[];n.d(e,"a",function(){return a}),n.d(e,"b",function(){return i})},f288:function(t,e,n){},ff9b:function(t,e,n){"use strict";n.r(e);var a=n("d76b"),i=n("af2c");for(var r in i)"default"!==r&&function(t){n.d(e,t,function(){return i[t]})}(r);n("a891");var c=n("2877"),u=Object(c["a"])(i["default"],a["a"],a["b"],!1,null,null,null);e["default"]=u.exports}},[["2ab4","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["mill/salepay/salepay"],{"1f09":function(t,e,n){},"2fd7":function(t,e,n){"use strict";n.r(e);var a=n("43c0"),r=n("b248");for(var c in r)"default"!==c&&function(t){n.d(e,t,function(){return r[t]})}(c);n("67bb");var u=n("2877"),i=Object(u["a"])(r["default"],a["a"],a["b"],!1,null,null,null);e["default"]=i.exports},"43c0":function(t,e,n){"use strict";var a=function(){var t=this,e=t.$createElement;t._self._c},r=[];n.d(e,"a",function(){return a}),n.d(e,"b",function(){return r})},"46ab":function(t,e,n){"use strict";(function(t){n("9c0b"),n("921b");a(n("66fd"));var e=a(n("2fd7"));function a(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,n("6e42")["createPage"])},"67bb":function(t,e,n){"use strict";var a=n("1f09"),r=n.n(a);r.a},b248:function(t,e,n){"use strict";n.r(e);var a=n("b8e7"),r=n.n(a);for(var c in a)"default"!==c&&function(t){n.d(e,t,function(){return a[t]})}(c);e["default"]=r.a},b8e7:function(t,e,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a=n("f7ed"),r={data:function(){return{type:"卖单",datn:"",state:"",mill:"",stw:"",price:"",rmb:"",x:"",time:"",name:"",contact:"",frte:!0,checkall:"查看全部"}},onLoad:function(t){var e=this,n=JSON.parse(t.aser);e.datn=n;e.datn[1];e.stw=e.datn[1],e.state=e.datn[0][0].order_status,e.mill=e.datn[0][0].sale_num,e.price=e.datn[0][0].sale_money,e.x=e.datn[0][0].order_num,e.name=e.datn[0][0].name,e.contact=e.datn[0][0].mobile,e.time=e.datn[0][0].set_time,101==e.state&&(e.state="待付款"),e.rmb=a.getrmb(e.price)},methods:{btn:function(){var t=this;t.frte=!t.frte,0==t.frte?t.checkall="收起":t.checkall="查看全部"}}};e.default=r}},[["46ab","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["mill/saleaudit/saleaudit"],{"2a73":function(t,e,n){"use strict";n.r(e);var a=n("b8a0"),i=n("e28b");for(var r in i)"default"!==r&&function(t){n.d(e,t,function(){return i[t]})}(r);n("33b3");var c=n("2877"),u=Object(c["a"])(i["default"],a["a"],a["b"],!1,null,null,null);e["default"]=u.exports},"33b3":function(t,e,n){"use strict";var a=n("90f3"),i=n.n(a);i.a},"4bc3":function(t,e,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a=n("f7ed"),i={data:function(){return{type:"卖出",vinda:"",state:"",mill:"",price:"",rmb:"",x:"",time_set:"",time_pay:"",clorn:"",time:"",name:"",contact:"",frte:!0,checkall:"查看全部"}},onLoad:function(t){var e=this,n=JSON.parse(t.suxang);e.vinda=n;e.vinda[1];e.clorn=e.vinda[1],e.state=n[0][0].order_status,103==e.state&&(e.state="待确认"),e.mill=e.vinda[0][0].sale_num,e.price=e.vinda[0][0].sale_money,e.x=e.vinda[0][0].order_num,e.name=e.vinda[0][0].name,e.contact=e.vinda[0][0].mobile,e.time=e.vinda[0][0].confirm_time,e.time_pay=e.vinda[0][0].pay_time,e.time_set=e.vinda[0][0].set_time,e.rmb=a.getrmb(e.price)},methods:{btn:function(){var t=this;t.frte=!t.frte,0==t.frte?t.checkall="收起":t.checkall="查看全部"}}};e.default=i},"90f3":function(t,e,n){},b8a0:function(t,e,n){"use strict";var a=function(){var t=this,e=t.$createElement;t._self._c},i=[];n.d(e,"a",function(){return a}),n.d(e,"b",function(){return i})},bff6:function(t,e,n){"use strict";(function(t){n("9c0b"),n("921b");a(n("66fd"));var e=a(n("2a73"));function a(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,n("6e42")["createPage"])},e28b:function(t,e,n){"use strict";n.r(e);var a=n("4bc3"),i=n.n(a);for(var r in a)"default"!==r&&function(t){n.d(e,t,function(){return a[t]})}(r);e["default"]=i.a}},[["bff6","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["mill/salecompleted/salecompleted"],{"18ff":function(t,e,n){"use strict";var a=function(){var t=this,e=t.$createElement;t._self._c},i=[];n.d(e,"a",function(){return a}),n.d(e,"b",function(){return i})},6512:function(t,e,n){},6806:function(t,e,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a=n("f7ed"),i={data:function(){return{type:"卖出",state:"",mill:"",price:"",rmb:"",x:"",pay_time:"",name:"",set_time:"",finish_time:"",confirm_time:"",nuecv:"",contact:"",italn:"",frte:!0,checkall:"查看全部"}},onLoad:function(t){var e=this,n=JSON.parse(t.cshug);e.italn=n;e.italn[1];e.nuecv=e.italn[1],e.state=n[0][0].order_status,104==e.state&&(e.state="已完成"),e.mill=n[0][0].sale_num,e.price=n[0][0].sale_money,e.x=n[0][0].order_num,e.name=n[0][0].name,e.contact=n[0][0].mobile,e.pay_time=n[0][0].pay_time,e.set_time=n[0][0].set_time,e.confirm_time=n[0][0].confirm_time,e.finish_time=n[0][0].finish_time,e.rmb=a.getrmb(e.price)},methods:{btn:function(){var t=this;t.frte=!t.frte,0==t.frte?t.checkall="收起":t.checkall="查看全部"}}};e.default=i},"6d36":function(t,e,n){"use strict";n.r(e);var a=n("6806"),i=n.n(a);for(var r in a)"default"!==r&&function(t){n.d(e,t,function(){return a[t]})}(r);e["default"]=i.a},"8a9e":function(t,e,n){"use strict";(function(t){n("9c0b"),n("921b");a(n("66fd"));var e=a(n("a24d"));function a(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,n("6e42")["createPage"])},"943f":function(t,e,n){"use strict";var a=n("6512"),i=n.n(a);i.a},a24d:function(t,e,n){"use strict";n.r(e);var a=n("18ff"),i=n("6d36");for(var r in i)"default"!==r&&function(t){n.d(e,t,function(){return i[t]})}(r);n("943f");var c=n("2877"),u=Object(c["a"])(i["default"],a["a"],a["b"],!1,null,null,null);e["default"]=u.exports}},[["8a9e","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["mill/assets/assets"],{"2d13":function(t,e,a){"use strict";(function(t){a("9c0b"),a("921b");n(a("66fd"));var e=n(a("41e0"));function n(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,a("6e42")["createPage"])},"41e0":function(t,e,a){"use strict";a.r(e);var n=a("e152"),i=a("a73e");for(var r in i)"default"!==r&&function(t){a.d(e,t,function(){return i[t]})}(r);a("ad53");var o=a("2877"),s=Object(o["a"])(i["default"],n["a"],n["b"],!1,null,null,null);e["default"]=s.exports},"51af":function(t,e,a){},a73e:function(t,e,a){"use strict";a.r(e);var n=a("c111"),i=a.n(n);for(var r in n)"default"!==r&&function(t){a.d(e,t,function(){return n[t]})}(r);e["default"]=i.a},ad53:function(t,e,a){"use strict";var n=a("51af"),i=a.n(n);i.a},c111:function(t,e,a){"use strict";(function(t,n){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var i=function(){return a.e("common/dy-Date").then(a.bind(null,"f716"))},r={data:function(){return{num:"",ber:"",nuber:"",fee:"",month_profit:"0",numm:"",tabCurrentIndex:0,add_item:"",profit:"0",entin:"",flag:!1,ention:"",index:0,navList:[{state:0,text:"收入记录"},{state:1,text:"支出记录"}],date:"本月",date1:"本月",teran:""}},components:{dyDatePicker:i},onShow:function(e){var a=this,n=new Date,i=n.getFullYear("-"),r=n.getMonth()+1,o=i+"-"+r;a.teran=o,t.request({url:this.url+"assets/",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(t){a.num=t.data.fil_count,a.ber=t.data.availed_num,a.nuber=t.data.locked_num,a.fee=t.data.fee}}),t.request({url:this.url+"assets/month/profit/",method:"GET",header:{Authorization:"JWT "+this.global_.token},data:{month:o},success:function(t){var e=t.data.data,n=t.data.data.profit_records;a.ention=n,0==n.length?a.flag=!0:a.flag=!1,a.month_profit=e.month_profit,a.add_item=n[0].add_time,a.numm=n[0].num}})},methods:{tabClick:function(e){var a=this,i=new Date,r=i.getFullYear("-"),o=i.getMonth()+1,s=r+"-"+o;if(a.teran=s,this.tabCurrentIndex===e)return!1;a.tabCurrentIndex=e,0===this.tabCurrentIndex&&(a.date="本月",t.request({url:this.url+"assets/month/profit/",method:"GET",header:{Authorization:"JWT "+this.global_.token},data:{month:s},success:function(t){var e=t.data.data,i=t.data.data.profit_records;a.ention=i,console.log(n(i," at mill\\assets\\assets.vue:188")),0==i.length?a.flag=!0:a.flag=!1,a.month_profit=e.month_profit,a.add_item=i[0].add_time,a.numm=i[0].num}})),1===this.tabCurrentIndex&&(a.date1="本月",t.request({url:this.url+"assets/month/bill/",method:"GET",header:{Authorization:"JWT "+this.global_.token},data:{month:s},success:function(t){var e=t.data.data,n=t.data.data.bill_records;a.entin=n,0==n.length?a.flag=!0:a.flag=!1,a.profit=e.month_bill,a.add_item=n[0].add_time,a.numm=n[0].num}}))},bindChange:function(t){var e=t.detail.value;this.year=this.years[e[0]],this.month=this.months[e[1]],this.day=this.days[e[2]]},btn:function(){t.navigateTo({url:"/my/transfer/transfer?bar="+this.ber+"&fee="+this.fee})},optionTap:function(e){var a=this,n=e.currentTarget.dataset.index;this.selectData[n];this.index=n,this.selectShow=!this.selectShow,t.request({url:this.url+"month/profit/",method:"GET",data:{month:a.selectData[a.index]},header:{Authorization:"JWT "+this.global_.token},success:function(t){}})},DateChange:function(e){var a=this;a.date=e,t.request({url:this.url+"assets/month/profit/",method:"GET",header:{Authorization:"JWT "+this.global_.token},data:{month:e},success:function(t){var e=t.data.data,n=t.data.data.profit_records;a.ention=n,0==n.length?a.flag=!0:a.flag=!1,a.month_profit=e.month_profit,a.add_time=n[0].add_time,a.numm=n[0].num}})},DateChang:function(e){var a=this;this.date1=e,t.request({url:this.url+"assets/month/bill/",method:"GET",header:{Authorization:"JWT "+this.global_.token},data:{month:e},success:function(t){var e=t.data.data,n=t.data.data.bill_records;a.entin=n,0==n.length?a.flag=!0:a.flag=!1,a.profit=e.month_bill,a.add_item=n[0].add_time,a.numm=n[0].num}})},transfer:function(){t.navigateTo({url:"../transfer/transfer"})}}};e.default=r}).call(this,a("6e42")["default"],a("0de9")["default"])},e152:function(t,e,a){"use strict";var n=function(){var t=this,e=t.$createElement;t._self._c},i=[];a.d(e,"a",function(){return n}),a.d(e,"b",function(){return i})}},[["2d13","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["mill/validation/validation"],{"0029":function(t,n,e){"use strict";var a=e("cca7"),o=e.n(a);o.a},"05a1":function(t,n,e){"use strict";var a=function(){var t=this,n=t.$createElement;t._self._c},o=[];e.d(n,"a",function(){return a}),e.d(n,"b",function(){return o})},"13c4":function(t,n,e){"use strict";(function(t){e("9c0b"),e("921b");a(e("66fd"));var n=a(e("2ba3"));function a(t){return t&&t.__esModule?t:{default:t}}t(n.default)}).call(this,e("6e42")["createPage"])},"2ba3":function(t,n,e){"use strict";e.r(n);var a=e("05a1"),o=e("e225");for(var i in o)"default"!==i&&function(t){e.d(n,t,function(){return o[t]})}(i);e("0029");var u=e("2877"),r=Object(u["a"])(o["default"],a["a"],a["b"],!1,null,null,null);n["default"]=r.exports},a3c3:function(t,n,e){"use strict";(function(t){Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var e={data:function(){return{name:"",coloe:""}},onLoad:function(t){var n=this,e=JSON.parse(t.app),a=JSON.parse(t.sunt),o=JSON.parse(t.tilo);n.data=e,n.date=a,n.datr=o},methods:{end:function(t){this.name=t.detail.value},ennd:function(t){this.coloe=t.detail.value},end1:function(){if(""==this.coloe)return t.showToast({icon:"none",title:"请输入手机号"}),!1;var n=/^(16[0-9]|14[0-9]|13[0-9]|15[0-9]|17[0-9]|18[0-9]|19[0-9])\d{8}$$/;if(!n.test(this.coloe))return t.showToast({title:"请输入正确的手机号",icon:"none",mask:!0,duration:2e3}),!1;var e=this,a=e.name,o=e.coloe,i=e.data,u=e.date,r=e.datr;t.request({url:this.url+"buildorders/",method:"POST",header:{Authorization:"JWT "+this.global_.token},data:{name:a,machine_id_list:i,mobile:o,sale_num:u,sale_money:r},success:function(n){var e=JSON.stringify(n.data.data);204==n.statusCode?t.showToast({title:"买家信息不存在",icon:"none"}):200==n.statusCode?t.navigateTo({url:"../confirm/confirm?ront="+e}):401==n.statusCode?t.showToast({title:"矿机不能卖给自己",icon:"none"}):400==n.statusCode&&t.showToast({title:"请重新出售"})}})}}};n.default=e}).call(this,e("6e42")["default"])},cca7:function(t,n,e){},e225:function(t,n,e){"use strict";e.r(n);var a=e("a3c3"),o=e.n(a);for(var i in a)"default"!==i&&function(t){e.d(n,t,function(){return a[t]})}(i);n["default"]=o.a}},[["13c4","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["my/address/address"],{"083f":function(n,e,t){},"0b23":function(n,e,t){"use strict";(function(n){t("9c0b"),t("921b");a(t("66fd"));var e=a(t("2c6b"));function a(n){return n&&n.__esModule?n:{default:n}}n(e.default)}).call(this,t("6e42")["createPage"])},"10de":function(n,e,t){"use strict";var a=t("083f"),s=t.n(a);s.a},"2c6b":function(n,e,t){"use strict";t.r(e);var a=t("f1d9"),s=t("c571");for(var o in s)"default"!==o&&function(n){t.d(e,n,function(){return s[n]})}(o);t("10de");var i=t("2877"),u=Object(i["a"])(s["default"],a["a"],a["b"],!1,null,null,null);e["default"]=u.exports},"93f9":function(n,e,t){"use strict";(function(n){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var a=function(){return Promise.all([t.e("common/vendor"),t.e("components/uni-swipe-action/uni-swipe-action")]).then(t.bind(null,"5eac"))},s=function(){return Promise.all([t.e("common/vendor"),t.e("components/keyboard-package/keyboard-package")]).then(t.bind(null,"bd7f"))},o=function(){return Promise.all([t.e("common/vendor"),t.e("components/password-input/password-input")]).then(t.bind(null,"d391"))},i=function(){return t.e("components/uni-nav-bar/uni-nav-bar").then(t.bind(null,"ba27"))},u={data:function(){return{options:[{text:"删除",style:{backgroundColor:"#dd524d"}}],wallet_value:"",wallet_key:"",address_out:"",flag:!0,right:"",id:"",shade:!0,password:"",user_id:"",numberList:[],length:6,type:"number",passIn:!1}},components:{uniSwipeAction:a,keyboardPackage:s,passwordInput:o,uniNavBar:i},onLoad:function(){var e=this;n.request({url:this.url+"walletaddress/",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(n){""==n.data.data?e.flag=!1:e.flag=!0,e.address_out=n.data.data}})},methods:{clo:function(){this.passIn=!1,this.$refs["number"].close(),this.numberList.length=0},onDelete:function(){this.numberList.pop()},onChange:function(n){0==n.show&&(this.passIn=!1),this.numberList.length=0},onConfirm:function(){6!=this.numberList.length&&n.showToast({title:"请输入六位交易密码！",duration:2e3,icon:"none"})},onInput:function(e){var t=this;t.numberList.push(e),t.password=t.numberList.join().replace(/,/g,""),t.numberList.length>=t.length&&(n.request({url:t.url+"updatadeleteaddress/",method:"DELETE",data:{id:t.id,password:t.password},header:{Authorization:"JWT "+t.global_.token},success:function(e){if(204==e.statusCode&&(t.passIn=!1,t.$refs["number"].close(),n.showToast({title:"删除成功",icon:"none",duration:2e3})),400==e.statusCode){t.$refs.wrong.flag=!1;var a=e.data.data.err_num,s=5-a;t.$refs.wrong.tip="剩余"+s+"次机会"}423==e.statusCode&&(t.passIn=!1,t.$refs["number"].close(),n.showToast({title:"交易密码已锁定,请在今日24:00后进行交易",icon:"none",duration:2e3}));var o=getCurrentPages().pop();void 0!=o&&null!=o&&o.onLoad()}}),this.numberList.length=0)},click:function(n){var e=this;e.id=n.id,this.passIn=!0,this.$refs["number"].open(),this.onInput(val)},add_address:function(){n.navigateTo({url:"../add-address/add-address?flag="+this.flag,success:function(n){},fail:function(){},complete:function(){}})},add:function(){n.navigateTo({url:"../add-address/add-address?flag="+this.flag,success:function(n){},fail:function(){},complete:function(){}})},back:function(){n.navigateBack({delta:1})},edit:function(e){var t=this;t.id=e.id,t.wallet_key=e.wallet_key,t.wallet_value=e.wallet_value,t.user_id=e.user_id,n.navigateTo({url:"../edit-address/edit-address?id="+t.id+"&wallet_key="+t.wallet_key+"&wallet_value="+t.wallet_value+"&user_id="+t.user_id,success:function(n){},fail:function(){},complete:function(){}})}}};e.default=u}).call(this,t("6e42")["default"])},c571:function(n,e,t){"use strict";t.r(e);var a=t("93f9"),s=t.n(a);for(var o in a)"default"!==o&&function(n){t.d(e,n,function(){return a[n]})}(o);e["default"]=s.a},f1d9:function(n,e,t){"use strict";var a=function(){var n=this,e=n.$createElement;n._self._c},s=[];t.d(e,"a",function(){return a}),t.d(e,"b",function(){return s})}},[["0b23","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["my/trade-password/trade-password"],{"0571":function(t,e,s){"use strict";s.r(e);var o=s("42d0"),a=s.n(o);for(var n in o)"default"!==n&&function(t){s.d(e,t,function(){return o[t]})}(n);e["default"]=a.a},"42d0":function(t,e,s){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var s={data:function(){return{isPassword:!0,isPassword1:!0,email:"",email1:"",code:"",codename:" 获取验证码",password:"",password1:"",shade:!1,disabled:!1,flag:!0}},onLoad:function(){var e=this;t.request({url:this.url+"delemail/",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(t){var s=t.data.data,o=t.data.data;e.email1=o;var a=s.split("@");s=a[0].substr(0,a[0].length-5)+"****@"+a[1],e.email=s}})},onBackPress:function(t){plus.key.hideSoftKeybord()},methods:{show:function(){this.isPassword=!this.isPassword},show1:function(){this.isPassword1=!this.isPassword1},getCodeValue:function(t){this.code=t.detail.value},getPassword:function(t){this.password=t.detail.value},getPassword1:function(t){this.password1=t.detail.value},getCode:function(){var e=this;t.request({method:"POST",data:{email:this.email1},url:this.url+"setemail/",header:{Authorization:"JWT "+this.global_.token},success:function(t){var s=121,o=setInterval(function(){s--,s<=0?(clearInterval(o),e.flag=!0,e.codename="重新发送",e.disabled=!1):(e.flag=!1,e.codename=s+"s",e.disabled=!0)},1e3)}})},getCodeNumber:function(t){this.getCode()},setPwd:function(){if(""==this.code)return t.showToast({icon:"none",title:"请输入验证码",duration:2e3}),!1;if(""==this.password)return t.showToast({icon:"none",title:"请输入交易密码",duration:2e3}),!1;var e=this.global_.checkPassword(this.password);return e?""==this.password1?(t.showToast({icon:"none",title:"请确认交易密码",duration:2e3}),!1):this.password1!==this.password?(t.showToast({icon:"none",title:"两次密码不一致",duration:2e3}),!1):void t.request({url:this.url+"setmoney/",method:"POST",data:{email:this.email1,email_msg:this.code,password:this.password,password1:this.password1},header:{Authorization:"JWT "+this.global_.token},success:function(e){200==e.statusCode&&(t.showToast({title:"资金密码已设置",icon:"none",duration:2e3}),t.switchTab({url:"../my/my"})),400==e.statusCode&&t.showToast({title:"验证码错误",icon:"none",duration:2e3})}}):(t.showToast({title:"交易密码为六位数字!",icon:"none",duration:2e3}),!1)}}};e.default=s}).call(this,s("6e42")["default"])},"6c98":function(t,e,s){},"84be":function(t,e,s){"use strict";var o=s("6c98"),a=s.n(o);a.a},b5e1:function(t,e,s){"use strict";var o=function(){var t=this,e=t.$createElement;t._self._c},a=[];s.d(e,"a",function(){return o}),s.d(e,"b",function(){return a})},bc87:function(t,e,s){"use strict";(function(t){s("9c0b"),s("921b");o(s("66fd"));var e=o(s("ecee"));function o(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,s("6e42")["createPage"])},ecee:function(t,e,s){"use strict";s.r(e);var o=s("b5e1"),a=s("0571");for(var n in a)"default"!==n&&function(t){s.d(e,t,function(){return a[t]})}(n);s("84be");var i=s("2877"),r=Object(i["a"])(a["default"],o["a"],o["b"],!1,null,null,null);e["default"]=r.exports}},[["bc87","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["my/change-otherPassword/change_otherPassword"],{"06e8":function(t,e,s){"use strict";var o=s("a957"),a=s.n(o);a.a},"1a8b":function(t,e,s){"use strict";(function(t){s("9c0b"),s("921b");o(s("66fd"));var e=o(s("5d2c"));function o(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,s("6e42")["createPage"])},"529b":function(t,e,s){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var s={data:function(){return{isPassword:!0,isPassword1:!0,email:"",email1:"",code:"",codename:" 获取验证码",password:"",password1:"",shade:!1,flag:!0,disabled:!1}},onLoad:function(){var e=this;t.request({url:this.url+"delemail/",method:"GET",header:{Authorization:"JWT "+this.global_.token},success:function(t){var s=t.data.data,o=t.data.data;e.email1=o;var a=s.split("@");s=a[0].substr(0,a[0].length-5)+"****@"+a[1],e.email=s}})},onBackPress:function(t){plus.key.hideSoftKeybord()},methods:{show:function(){this.isPassword=!this.isPassword},show1:function(){this.isPassword1=!this.isPassword1},getCodeValue:function(t){this.code=t.detail.value},getPassword:function(t){this.password=t.detail.value},getPassword1:function(t){this.password1=t.detail.value},getCode:function(){var e=this;t.request({method:"POST",data:{email:this.email1},url:this.url+"setemail/",header:{Authorization:"JWT "+this.global_.token},success:function(t){var s=121,o=setInterval(function(){s--,s<=0?(clearInterval(o),e.flag=!0,e.codename="重新发送",e.disabled=!1):(e.flag=!1,e.codename=s+"s",e.disabled=!0)},1e3)}})},getCodeNumber:function(t){this.getCode()},setPwd:function(){if(""==this.code)return t.showToast({icon:"none",title:"请输入验证码",duration:2e3}),!1;if(""==this.password)return t.showToast({icon:"none",title:"请输入交易密码",duration:2e3}),!1;var e=this.global_.checkPassword(this.password);return e?""==this.password1?(t.showToast({icon:"none",title:"请确认交易密码",duration:2e3}),!1):this.password1!==this.password?(t.showToast({icon:"none",title:"两次密码不一致",duration:2e3}),!1):void t.request({url:this.url+"setmoney/",method:"POST",data:{email:this.email1,email_msg:this.code,password:this.password,password1:this.password1},header:{Authorization:"JWT "+this.global_.token},success:function(e){200==e.statusCode&&(t.showToast({title:"资金密码已修改",icon:"none",duration:2e3}),t.switchTab({url:"../my/my"})),400==e.statusCode&&t.showToast({title:"验证码错误",icon:"none",duration:2e3})}}):(t.showToast({title:"交易密码为六位数字",icon:"none",duration:2e3}),!1)}}};e.default=s}).call(this,s("6e42")["default"])},5547:function(t,e,s){"use strict";var o=function(){var t=this,e=t.$createElement;t._self._c},a=[];s.d(e,"a",function(){return o}),s.d(e,"b",function(){return a})},"5d2c":function(t,e,s){"use strict";s.r(e);var o=s("5547"),a=s("8ed4");for(var n in a)"default"!==n&&function(t){s.d(e,t,function(){return a[t]})}(n);s("06e8");var i=s("2877"),r=Object(i["a"])(a["default"],o["a"],o["b"],!1,null,null,null);e["default"]=r.exports},"8ed4":function(t,e,s){"use strict";s.r(e);var o=s("529b"),a=s.n(o);for(var n in o)"default"!==n&&function(t){s.d(e,t,function(){return o[t]})}(n);e["default"]=a.a},a957:function(t,e,s){}},[["1a8b","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["my/my-machine/my-machine"],{"12d8":function(e,n,a){},"2f92":function(e,n,a){"use strict";(function(e){a("9c0b"),a("921b");t(a("66fd"));var n=t(a("cb73"));function t(e){return e&&e.__esModule?e:{default:e}}e(n.default)}).call(this,a("6e42")["createPage"])},5810:function(e,n,a){"use strict";var t=function(){var e=this,n=e.$createElement;e._self._c},u=[];a.d(n,"a",function(){return t}),a.d(n,"b",function(){return u})},"5e0c":function(e,n,a){"use strict";(function(e,a){Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var t={data:function(){return{flag:!1,user_machine:"",machine_id:"",user_agreement:"",shade:!1}},onShow:function(){var n=this;e.request({url:this.url+"usermachine/",method:"GET",data:{},header:{Authorization:"JWT "+this.global_.token},success:function(e){console.log(a(e," at my\\my-machine\\my-machine.vue:95")),n.user_machine=e.data.data.machine_datas,n.user_agreement=e.data.data.user_agreement,0==n.user_agreement?n.shade=!0:1==n.user_agreement&&(n.shade=!1),console.log(a(n.user_agreement," at my\\my-machine\\my-machine.vue:103")),""==e.data.data&&(n.flag=!0)},fail:function(){},complete:function(){}})},methods:{sure:function(){e.navigateTo({url:"../../pages/agreement/agreement"})},cancel:function(){e.navigateBack({url:"../my/my"})},onNavigationBarButtonTap:function(){e.navigateTo({url:"../../pages/agreement/agreement"})},select:function(n){e.navigateTo({url:"../machine-detail/machine-detail?machine_id="+n.machine_id})}}};n.default=t}).call(this,a("6e42")["default"],a("0de9")["default"])},cb73:function(e,n,a){"use strict";a.r(n);var t=a("5810"),u=a("d695");for(var c in u)"default"!==c&&function(e){a.d(n,e,function(){return u[e]})}(c);a("f90e");var i=a("2877"),r=Object(i["a"])(u["default"],t["a"],t["b"],!1,null,null,null);n["default"]=r.exports},d695:function(e,n,a){"use strict";a.r(n);var t=a("5e0c"),u=a.n(t);for(var c in t)"default"!==c&&function(e){a.d(n,e,function(){return t[e]})}(c);n["default"]=u.a},f90e:function(e,n,a){"use strict";var t=a("12d8"),u=a.n(t);u.a}},[["2f92","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["my/suggest/suggest"],{"0f3d":function(t,e,a){"use strict";var s=a("aba2"),n=a.n(s);n.a},"32de":function(t,e,a){"use strict";(function(t){a("9c0b"),a("921b");s(a("66fd"));var e=s(a("ac1a"));function s(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,a("6e42")["createPage"])},"866f":function(t,e,a){"use strict";var s=function(){var t=this,e=t.$createElement;t._self._c},n=[];a.d(e,"a",function(){return s}),a.d(e,"b",function(){return n})},aba2:function(t,e,a){},ac1a:function(t,e,a){"use strict";a.r(e);var s=a("866f"),n=a("f74a");for(var i in n)"default"!==i&&function(t){a.d(e,t,function(){return n[t]})}(i);a("0f3d");var u=a("2877"),o=Object(u["a"])(n["default"],s["a"],s["b"],!1,null,null,null);e["default"]=o.exports},f74a:function(t,e,a){"use strict";a.r(e);var s=a("fd68"),n=a.n(s);for(var i in s)"default"!==i&&function(t){a.d(e,t,function(){return s[t]})}(i);e["default"]=n.a},fd68:function(t,e,a){"use strict";(function(t,a){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var s={data:function(){return{flag:!1,hidden:!0,title:"",desc:"",messages:"",id:"",add_time:""}},onLoad:function(){var e=this;t.request({url:this.url+"advicefeedback/",method:"GET",data:{title:this.title,message:this.desc},header:{Authorization:"JWT "+this.global_.token},success:function(t){console.log(a(t," at my\\suggest\\suggest.vue:71")),""==t.data.data?e.flag=!0:e.flag=!1,e.messages=t.data.data;for(var s=0;s<e.messages.length;s++){var n=e.messages[s].add_time,i=n.substr(0,10)+"  "+n.substr(11,8);e.messages[s].add_time=i;var u=e.messages[s].updated_time,o=u.substr(0,10)+"  "+u.substr(11,8);e.messages[s].updated_time=o}}})},onBackPress:function(t){plus.key.hideSoftKeybord()},methods:{getTitleContent:function(t){this.title=t.detail.value},getDescContent:function(t){this.desc=t.detail.value},addMessage:function(){this.hidden=!1},close:function(){this.hidden=!0},submit:function(){var e=this;return""==this.title?(t.showToast({title:"标题不能为空",icon:"none",duration:2e3}),!1):""==this.desc?(t.showToast({title:"请描述您的问题",icon:"none",duration:2e3}),!1):void t.request({url:this.url+"advicefeedback/",method:"POST",data:{title:this.title,message:this.desc},header:{Authorization:"JWT "+this.global_.token},success:function(a){200==a.statusCode&&(e.hidden=!0,e.title="",e.desc=""),t.showToast({title:"提交成功",icon:"none",duration:2e3});var s=getCurrentPages().pop();void 0!=s&&null!=s&&s.onLoad()}})},detail:function(e){var a=JSON.stringify(e);t.navigateTo({url:"../suggest-detail/suggest-detail?message="+a})},identity:function(){t.navigateTo({url:"../identity/identity"})}}};e.default=s}).call(this,a("6e42")["default"],a("0de9")["default"])}},[["32de","common/runtime","common/vendor"]]]);
});
