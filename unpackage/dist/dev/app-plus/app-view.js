...
var bEJB=_mz(z,'view',['bindtap',7,'class',1,'data-event-opts',2,'id',3],[],aBJB,lAJB,gg)
var oFJB=_n('view')
_rz(z,oFJB,'class',11,aBJB,lAJB,gg)
var xGJB=_n('view')
var oHJB=_v()
_(xGJB,oHJB)
if(_oz(z,12,aBJB,lAJB,gg)){oHJB.wxVkey=1
var hKJB=_n('view')
var oLJB=_mz(z,'image',['class',13,'src',1],[],aBJB,lAJB,gg)
_(hKJB,oLJB)
_(oHJB,hKJB)
}
else{oHJB.wxVkey=2
var cMJB=_v()
_(oHJB,cMJB)
if(_oz(z,15,aBJB,lAJB,gg)){cMJB.wxVkey=1
var oNJB=_n('view')
var lOJB=_mz(z,'image',['class',16,'src',1],[],aBJB,lAJB,gg)
_(oNJB,lOJB)
_(cMJB,oNJB)
}
cMJB.wxXCkey=1
...
var fIJB=_v()
_(xGJB,fIJB)
if(_oz(z,18,aBJB,lAJB,gg)){fIJB.wxVkey=1
var aPJB=_n('view')
var tQJB=_mz(z,'image',['class',19,'src',1],[],aBJB,lAJB,gg)
_(aPJB,tQJB)
_(fIJB,aPJB)
}
var cJJB=_v()
_(xGJB,cJJB)
if(_oz(z,21,aBJB,lAJB,gg)){cJJB.wxVkey=1
var eRJB=_n('view')
var bSJB=_mz(z,'image',['class',22,'src',1],[],aBJB,lAJB,gg)
_(eRJB,bSJB)
_(cJJB,eRJB)
}
oHJB.wxXCkey=1
...
_(oFJB,xGJB)
var oTJB=_n('view')
var xUJB=_mz(z,'image',['class',24,'src',1],[],aBJB,lAJB,gg)
_(oTJB,xUJB)
_(oFJB,oTJB)
var oVJB=_mz(z,'image',['class',26,'src',1],[],aBJB,lAJB,gg)
_(oFJB,oVJB)
var fWJB=_n('text')
_rz(z,fWJB,'class',28,aBJB,lAJB,gg)
var cXJB=_oz(z,29,aBJB,lAJB,gg)
_(fWJB,cXJB)
_(oFJB,fWJB)
var hYJB=_n('text')
_rz(z,hYJB,'class',30,aBJB,lAJB,gg)
var oZJB=_oz(z,31,aBJB,lAJB,gg)
_(hYJB,oZJB)
_(oFJB,hYJB)
var c1JB=_n('text')
_rz(z,c1JB,'class',32,aBJB,lAJB,gg)
var o2JB=_oz(z,33,aBJB,lAJB,gg)
_(c1JB,o2JB)
_(oFJB,c1JB)
var l3JB=_n('view')
var a4JB=_v()
_(l3JB,a4JB)
if(_oz(z,34,aBJB,lAJB,gg)){a4JB.wxVkey=1
var o0JB=_n('view')
var fAKB=_n('text')
_rz(z,fAKB,'class',35,aBJB,lAJB,gg)
var cBKB=_oz(z,36,aBJB,lAJB,gg)
_(fAKB,cBKB)
_(o0JB,fAKB)
_(a4JB,o0JB)
}
var t5JB=_v()
_(l3JB,t5JB)
if(_oz(z,37,aBJB,lAJB,gg)){t5JB.wxVkey=1
var hCKB=_n('view')
var oDKB=_n('text')
_rz(z,oDKB,'class',38,aBJB,lAJB,gg)
var cEKB=_oz(z,39,aBJB,lAJB,gg)
_(oDKB,cEKB)
_(hCKB,oDKB)
_(t5JB,hCKB)
}
var e6JB=_v()
_(l3JB,e6JB)
if(_oz(z,40,aBJB,lAJB,gg)){e6JB.wxVkey=1
var oFKB=_n('view')
var lGKB=_n('text')
_rz(z,lGKB,'class',41,aBJB,lAJB,gg)
var aHKB=_oz(z,42,aBJB,lAJB,gg)
_(lGKB,aHKB)
_(oFKB,lGKB)
_(e6JB,oFKB)
}
var b7JB=_v()
_(l3JB,b7JB)
if(_oz(z,43,aBJB,lAJB,gg)){b7JB.wxVkey=1
var tIKB=_n('view')
var eJKB=_n('text')
_rz(z,eJKB,'class',44,aBJB,lAJB,gg)
var bKKB=_oz(z,45,aBJB,lAJB,gg)
_(eJKB,bKKB)
_(tIKB,eJKB)
_(b7JB,tIKB)
}
var o8JB=_v()
_(l3JB,o8JB)
if(_oz(z,46,aBJB,lAJB,gg)){o8JB.wxVkey=1
var oLKB=_n('view')
var xMKB=_n('text')
_rz(z,xMKB,'class',47,aBJB,lAJB,gg)
var oNKB=_oz(z,48,aBJB,lAJB,gg)
_(xMKB,oNKB)
_(oLKB,xMKB)
_(o8JB,oLKB)
}
var x9JB=_v()
_(l3JB,x9JB)
if(_oz(z,49,aBJB,lAJB,gg)){x9JB.wxVkey=1
var fOKB=_n('view')
var cPKB=_n('text')
_rz(z,cPKB,'class',50,aBJB,lAJB,gg)
var hQKB=_oz(z,51,aBJB,lAJB,gg)
_(cPKB,hQKB)
_(fOKB,cPKB)
_(x9JB,fOKB)
}
...
_(bEJB,oFJB)
var oRKB=_n('view')
_rz(z,oRKB,'class',52,aBJB,lAJB,gg)
_(bEJB,oRKB)
_(tCJB,bEJB)
return tCJB
}
...
_(cSKB,oTKB)
var lUKB=_n('view')
var aVKB=_mz(z,'image',['mode',-1,'class',54,'src',1],[],e,s,gg)
_(lUKB,aVKB)
var tWKB=_n('view')
_rz(z,tWKB,'class',56,e,s,gg)
var eXKB=_oz(z,57,e,s,gg)
_(tWKB,eXKB)
_(lUKB,tWKB)
_(cSKB,lUKB)
_(c6IB,cSKB)
