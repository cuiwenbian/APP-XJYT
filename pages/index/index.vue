<template>
    <view class="container">
        ...
        <swiper indicator-dots autoplay interval="3000" circular indicator-color="rgda(255 , 255 , 255 , .6)">
            <swiper-item><image class="ttt" src="../../static/images/banner1.png"></image></swiper-item>
            <swiper-item><image class="ttt" src="../../static/images/banner3.png"></image></swiper-item>
            <swiper-item><image class="ttt" src="../../static/images/lb.png"></image></swiper-item>
        </swiper>
        ...
        <view class="gg">
            <div class="charts">
                <view class="qiun-columns">
                    <view class="qiun-charts"><canvas canvas-id="canvasArea" id="canvasArea" class="charts" @touchstart="touchArea"></canvas></view>
                </view>
            </div>
        </view>
           	...
           	uni.request({
           			...
           			success: function(res) {
						...
						for(let i=1;i<that.usd.length-1;i++){
								var data=a[i].split(",");
								var t=formatDate(parseInt(data[0]));
								time.push(t);
								that.time=time;
                                var high =data[2];
                                var low = data[3];
				...
				canvaArea=new uCharts({
									...
									series: [   //数据列表
									          ...
									          },
											 {
											   ...
											   color: "#1890ff" //颜色,不传入则使用系统默认配色方案
											 },
